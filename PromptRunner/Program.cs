...
namespace PromptRunner
{
    ...
    internal class Program
    {
        private static readonly Dictionary<string, Prompt> Prompts = new Dictionary<string, Prompt>{
            ...
            {"PromptCard2",  new Prompt{ Service = PromptService.GoogleGemini, PromptText = "Kun je me helpen de tekst op onderstaande pagina te herschrijven zodat deze duidelijker en beknopter wordt? Breng deze op niveau van een 13-jarige. https://zowerkthetlichaam.nl/39/longen-en-ademhaling/" }},
